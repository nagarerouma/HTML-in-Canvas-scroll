...
学習中に遭遇した、**「ネイティブスクロールが動作しない（透明になる）」** という現象とその回避策についてまとめています。最初に公式ドキュメントを読んでいれば迷わなかったことです。


https://github.com/user-attachments/assets/f075756a-faec-479a-9de8-76499b3ddcc6
